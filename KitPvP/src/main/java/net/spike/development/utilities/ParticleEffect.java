...
public enum ParticleEffect {
    ...
    private PacketPlayOutWorldParticles createPacket(float x, float y, float z, float offsetX, float offsetY, float offsetZ, float speed, int amount) {
        ...
        Preconditions.checkArgument(amount > 0, "Cannot use less then one particle.");
        return new PacketPlayOutWorldParticles(EnumParticle.valueOf(this.name), true, x, y, z, offsetX, offsetY, offsetY, speed, amount);
    }
